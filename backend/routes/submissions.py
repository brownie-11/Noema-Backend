...
from backend.models import User, Submission, SubmissionStatus
...
@router.post("/submit-thought", response_model=SubmissionPublic, status_code=status.HTTP_201_CREATED)
def submit_thought(
    ...
    - Admin notified by email (async, non-blocking)
    """
...
def get_submission(
    ...
    """Get a specific submission. Users can only see their own; admins see all."""
