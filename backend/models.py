...
class ThoughtConnection(Base):
    ...
    id              = Column(Integer, primary_key=True, index=True)
    source_node_id  = Column(Integer, ForeignKey("thought_nodes.id"), nullable=False, index=True)
    target_node_id  = Column(Integer, ForeignKey("thought_nodes.id"), nullable=False, index=True)
